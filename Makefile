NAME				=	minishell
LIBFT				=	libft/libft.a
SRC					=	builtins/exec_echo.c builtins/exec_env.c builtins/exec_export.c builtins/exec_pwd.c builtins/exec_unset.c builtins/exec_exit.c builtins/exec_export.c \
